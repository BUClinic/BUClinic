                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="medinventoryform.php">Medicine Inventory Form</a></li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h2> MEDICINE INVENTORY FORM <i class="icon-note float-left"></i> </h2>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-12 col-sm-12 mb-2">
                                                    ...
                                                    <input type="date" class="form-control mb-2" name="M_EDate" placeholder="Expiry Date" onfocus="this.type='date'">
                                                </div>
