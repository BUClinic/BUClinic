...
if(isset($_POST['submit'])){
	...
	echo $Course;
	echo $CollegeUnit;
	$sql = "INSERT INTO tbl_patientinfo (PatientID, Lname, Fname, Mname, Address,Region,Province,MuniCity,Brgy,Street, Age,Religion, Birthdate, Course, YearLevel, CollegeUnit, ContactNum, CivilStatus,Sex,ModifiedDate,CreatedDate,Modifiedby,CreatedBy)
	VALUES ('$PatientID', '$Lname', '$Fname', '$Mname', '$Address', '$region', '$province','$municity','$brgy','$street','$Age','$Relgion','$Birthdate', '$Course', '$YearLevel', '$CollegeUnit', '$ContactNum', '$CivilStatus','$Sex',null,null,'$Modifiedby','$CreatedBy')";
